...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    public static final int BUTTON_SETTING = 4;
    ...
    private void init(AttributeSet attrs) {
        ...
        searchIconRes = array.getResourceId(R.styleable.MaterialSearchBar_mt_searchIconDrawable, R.drawable.ic_search);
     ...
     */
    public void disableSearch(boolean isLeftMenu) {
        if (isLeftMenu){
            animateNavIcon();
        }
        ...
        if (placeholderText != null && isLeftMenu) {
...
//            popupMenu.show();
//            navIconShown = true;
            onSearchActionListener.onButtonClicked(BUTTON_SETTING);
            Log.d("hailpt"," popupMenu.show() ");
