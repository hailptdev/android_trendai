...
class AchievementAdapter(private val topicDetails: List<CategoryRes>) : RecyclerView.Adapter<AchievementAdapter.MyViewHolder>() {
    var onItemClick: ((CategoryRes) -> Unit)? = null
